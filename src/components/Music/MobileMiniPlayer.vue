...
.mobile-mini-player__queue { display: block; width: 100%; min-height: 44px; padding: 6px 12px; border: 0; background: transparent; text-align: left; color: var(--color-text-primary); cursor: pointer; }
