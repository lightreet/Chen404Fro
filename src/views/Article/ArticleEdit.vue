...
import ArticleOutline from '@/components/Editor/ArticleOutline.vue';
import { useArticleEdit } from '@/composables/article-edit/useArticleEdit';
import { useArticleOutline } from '@/composables/article-edit/useArticleOutline';
...
const {
  ...
  updateHeadings: updateOutlineHeadings,
  navigateToHeading,
} = useArticleOutline(editorRef, paperEditorHostRef);
